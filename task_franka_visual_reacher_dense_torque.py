...
from relod.envs.visual_franka_reacher.franka_torque_env import FrankaPanda_Visual_Reacher
...
def parse_args():
    parser = argparse.ArgumentParser(description='Local Franka Visual Dense Task')
    # environment
    ...
    parser.add_argument('--size_tol', default=0.99, type=float)
    ...
    parser.add_argument('--xtick', default=750, type=int)
